...
void openGripper(trajectory_msgs::JointTrajectory& posture)
{
  ...
  posture.joint_names[0] = "right_arm_left_inner_finger_joint";
  posture.joint_names[1] = "right_arm_right_inner_knuckle_joint";
  posture.joint_names[2] = "right_arm_finger_joint";
  posture.joint_names[3] = "right_arm_right_inner_finger_joint";
  posture.joint_names[4] = "right_arm_left_inner_knuckle_joint";
  posture.joint_names[5] = "right_arm_right_outer_knuckle_joint";
...
int main(int argc, char** argv)
{
  ...
  moveit::planning_interface::MoveGroupInterface group("right_arm_arm"); // need prefix?
